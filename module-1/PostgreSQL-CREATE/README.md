...
1. **After writing and testing all the statements, save your queries in a text file with the name `create.sql`**. This `.sql` file will be one of your deliverables. A `.sql` file is often used by software/data engineers to automate database operations. Many programming languages such as Python and PHP can also execute `.sql` files.
